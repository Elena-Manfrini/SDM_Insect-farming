...
#### 1.3 Human population density from Gao et al., 2020
...
for (i in 1:length(Vect_Sp)) {
  ...
  ############# 4.1 Occurrences filtering
    ### 4.1.a Remove occurrences outside land
    ...
    ### 4.1.b Remove duplicated occurrences in Environmental Space
...
for (i in 1:7) {
  ...
  ### 7.2 Projection Mean : Ensemble model
